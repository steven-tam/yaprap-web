...
import YapImage from '../components/howitworks-items/YapImage'
import RapImage from '../components/howitworks-items/RapImage'

function Display() {
    return (
          <div className="relative my-16 min-h-screen text-center py-10">
