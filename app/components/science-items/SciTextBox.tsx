...
function SciTextBox() {
    ...
    return (
      <motion.div 
        ...
        <p className="text-gray-500 p-1 text-lg">We&apos;ve done extensive research on <span className="font-bold">communication</span> and <span className="font-bold">creativity</span> so you don&apos;t have to</p>
      </motion.div>
    )
}
